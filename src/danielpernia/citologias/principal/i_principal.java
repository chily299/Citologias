...
public class i_principal extends JFrame {
		...
		comboBox_14.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				if(comboBox_14.getSelectedIndex() == 0){
					...
					comboBox_15.addItem("OTROS HALLAZGOS NO NEOPL�SICOS");
					comboBox_15.addItem("");
				}if(comboBox_14.getSelectedIndex() == 1){
					comboBox_15.addItem("C�LULAS ENDOMETRIALES  (mujer mayor de 40 a�os) ");
					comboBox_15.addItem("");
				}if(comboBox_14.getSelectedIndex() == 2){
					comboBox_15.addItem("C�LULAS ESCAMOSAS");
					comboBox_15.addItem("C�LULAS GLANDULARES");
					comboBox_15.addItem("");
		...
		comboBox_15.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				...
				if(comboBox_14.getSelectedIndex() == 0 &&comboBox_15.getSelectedIndex() == 0 ){
					...
					comboBox_16.addItem("Elementos mic�ticos de caracter�sticas morfol�gicas compatibles con Candida");
			...
			comboBox_16.addItemListener(new ItemListener() {
				public void itemStateChanged(ItemEvent arg0) {
					...
					if(comboBox_14.getSelectedIndex() == 0 && comboBox_15.getSelectedIndex() == 1 && comboBox_16.getSelectedIndex() == 0 ){
						comboBox_17.addItem("Inflamaci�n");
						comboBox_17.addItem("Radiaci�n");
						...
						comboBox_17.addItem("con hallazgos sospechosos de invaci�n");
						comboBox_17.addItem("");
					}else if(comboBox_14.getSelectedIndex() == 2 && comboBox_15.getSelectedIndex() == 1 && comboBox_16.getSelectedIndex() == 0 ){
						comboBox_17.addItem("C�lulas endocervicales");
						comboBox_17.addItem("C�lulas endometriales");
						comboBox_17.addItem("C�lulas glandulares");
		...
		btnNewButton_10.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(comboBox_24.getSelectedIndex() == 0){ // 1 mes 
					...
					diasConsulta = 180;
				}else if (comboBox_24.getSelectedIndex() == 3){ // 1 a�o
					diasConsulta = 365;
		...
		comboBox_28.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				if(comboBox_28.getSelectedIndex() == 0){
					...
					comboBox_29.addItem("OTROS HALLAZGOS NO NEOPL�SICOS");
					comboBox_29.addItem("");
				}if(comboBox_28.getSelectedIndex() == 1){
					comboBox_29.addItem("C�LULAS ENDOMETRIALES  (mujer mayor de 40 a�os) ");
					comboBox_29.addItem("");
				}if(comboBox_28.getSelectedIndex() == 2){
					comboBox_29.addItem("C�LULAS ESCAMOSAS");
					comboBox_29.addItem("C�LULAS GLANDULARES");
					comboBox_29.addItem("");
		...
		comboBox_29.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				...
				if(comboBox_28.getSelectedIndex() == 0 &&comboBox_29.getSelectedIndex() == 0 ){
					...
					comboBox_30.addItem("Elementos mic�ticos de caracter�sticas morfol�gicas compatibles con Candida");
					comboBox_30.addItem("Cambios de la flora vaginal sugerentes de VAGINOSIS BACTERIANA");
					comboBox_30.addItem("Bacterias de caracter�sticas morfol�gicas compatibles con Actinomyces");
					...
					comboBox_30.addItem("C�lulas glandulares poshisterectom�a");
					comboBox_30.addItem("Atrofia");
					
				}if(comboBox_28.getSelectedIndex() == 1 && comboBox_29.getSelectedIndex() == 0){
					comboBox_30.addItem("NEGATIVO PARA LESI�N ESCAMOSA INTRAEPITELIAL");
				}if(comboBox_28.getSelectedIndex() == 2  && comboBox_29.getSelectedIndex() == 0){
					comboBox_30.addItem("C�LULAS ESCAMOSAS AT�PICAS");
					comboBox_30.addItem("LESI�N ESCAMOSA INTRAEPITELIAL DE BAJO GRADO (LSIL)");
					comboBox_30.addItem("LESI�N ESCAMOSA INTRAEPITELIAL DE ALTO GRADO (HSIL)");
					comboBox_30.addItem("CARCINOMA ESCAMOSO");
				}if(comboBox_28.getSelectedIndex() == 2  && comboBox_29.getSelectedIndex() == 1){
					comboBox_30.addItem("AT�PICAS");
					comboBox_30.addItem("AT�PICAS SUGESTIVAS A NEOPLASIA");
		...
		comboBox_30.addItemListener(new ItemListener() {
				public void itemStateChanged(ItemEvent arg0) {
					...
					if(comboBox_28.getSelectedIndex() == 0 && comboBox_29.getSelectedIndex() == 1 && comboBox_30.getSelectedIndex() == 0 ){
						comboBox_31.addItem("Inflamaci�n");
						comboBox_31.addItem("Radiaci�n");
						...
						comboBox_31.addItem("con hallazgos sospechosos de invaci�n");
						comboBox_31.addItem("");
					}else if(comboBox_28.getSelectedIndex() == 2 && comboBox_29.getSelectedIndex() == 1 && comboBox_30.getSelectedIndex() == 0 ){
						comboBox_31.addItem("C�lulas endocervicales");
						comboBox_31.addItem("C�lulas endometriales");
						comboBox_31.addItem("C�lulas glandulares");
		...
		gl_Usuarios.setHorizontalGroup(
			gl_Usuarios.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_Usuarios.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_Usuarios.createParallelGroup(Alignment.LEADING)
						.addComponent(panel_9, GroupLayout.PREFERRED_SIZE, 816, GroupLayout.PREFERRED_SIZE)
		...
		gl_Usuarios.setVerticalGroup(
			gl_Usuarios.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_Usuarios.createSequentialGroup()
					...
					.addComponent(lblNewLabel_36)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(panel_9, GroupLayout.PREFERRED_SIZE, 264, GroupLayout.PREFERRED_SIZE)
				...
				.addGroup(gl_panel_9.createSequentialGroup()
					...
					.addGroup(gl_panel_9.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_9.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED))
						.addGroup(gl_panel_9.createParallelGroup(Alignment.LEADING)
							.addComponent(lblNombre_1, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE)
							.addGroup(gl_panel_9.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_9.createSequentialGroup()
									.addComponent(lblNombre_2, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE)
									.addGap(18))
								.addGroup(gl_panel_9.createSequentialGroup()
	...
	public void actualizarTabla(Vector<estudio_citologico> estudio_v){
		...
		table.setModel(new DefaultTableModel(
				datos,
				new String[] {
					"Codigo", "Paciente", "Medico", "Fecha de recepci�n de muestra", "Fecha resultado"
				}
			));
