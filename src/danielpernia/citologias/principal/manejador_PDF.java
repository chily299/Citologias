...
public class manejador_PDF {
	...
	public void crearPaginaPDF(Document documento,estudio_citologico estudio,paciente paciente_,medico medico_){
		...
		sub_titulo_informacion_g ="INFORMACI�N GINECOL�GICA:";
		...
		sub_titulo_categoria="CATEGORIZACI�N GENERAL:";
		info_categoria="";
		
		if(estudio.info_muestra1 == 0){ // satisfactoria
			if(estudio.clasificacion1 == 0){
				info_categoria+="NEGATIVO PARA LESI�N INTRAEPITELIAL O MALIGNIDAD\n";
				if(estudio.clasificacion2 == 0){
					...
					if(estudio.clasificacion3 == 0){
						...
						info_categoria+="Elementos mic�ticos de caracter�sticas morfol�gicas compatibles con Candida ";
						...
						info_categoria+="Bacterias de caracter�sticas morfol�gicas compatibles con Actinomyces ";
				...
				info_categoria+="OTROS HALLAZGOS\n";
				 if(estudio.clasificacion2 == 0){
						info_categoria+="C�LULAS ENDOMETRIALES  (mujer mayor de 40 a�os)  ";
						if(estudio.clasificacion3 == 0){
							info_categoria+="NEGATIVO PARA LESI�N ESCAMOSA INTRAEPITELIAL ";
					 }
				 }
			}else if(estudio.clasificacion1 == 2){
				info_categoria+="ANOMAL�AS DE LAS C�LULAS EPITELIALES\n";
				if(estudio.clasificacion2 == 0){
					info_categoria+="C�LULAS ESCAMOSAS: ";
					if(estudio.clasificacion3 == 0){
						info_categoria+="C�LULAS ESCAMOSAS AT�PICAS ";
						if(estudio.clasificacion4 == 0){
						...
						info_categoria+="LESI�N ESCAMOSA INTRAEPITELIAL DE BAJO GRADO (LSIL) ";
					}else if(estudio.clasificacion3 == 2){
						info_categoria+="LESI�N ESCAMOSA INTRAEPITELIAL DE ALTO GRADO (HSIL) ";
						if(estudio.clasificacion4 == 0){
							info_categoria+="con hallazgos sospechosos de invaci�n ";
						}
					}else if(estudio.clasificacion3 == 3){
				...
				if(estudio.clasificacion2 == 1){
					info_categoria+="C�LULAS GLANDULARES: ";
					if(estudio.clasificacion3 == 0){
						info_categoria+="AT�PICAS ";
						if(estudio.clasificacion4 == 0){
							info_categoria+="C�lulas endocervicales ";
						}else if(estudio.clasificacion4 == 1){
							info_categoria+="C�lulas endometriales ";
						}else if(estudio.clasificacion4 == 2){
							info_categoria+="C�lulas glandulares ";
						}
					}else if(estudio.clasificacion3 == 1){
						info_categoria+="AT�PICAS SUGESTIVAS A NEOPLASIA ";
						if(estudio.clasificacion4 == 0){
							info_categoria+="C�lulas endocervicales ";
						}else if(estudio.clasificacion4 == 1){
							info_categoria+="C�lulas glandulares ";
			...
			info_categoria+= "Insatisfactoria para evaluaci�n ";
			if(estudio.info_muestra2 == 0){
				...
				info_categoria+= "Muestra procesada y examinada pero insatisfactoria para la evaluaci�n de anomal�a epiteliales  ";
				if(estudio.info_muestra3 == 0){
		...
		if(estudio.clasificacion_detalle!=null && !estudio.clasificacion_detalle.isEmpty()){
			info_categoria+="\nObservaci�n: "+estudio.clasificacion_detalle;
		}
